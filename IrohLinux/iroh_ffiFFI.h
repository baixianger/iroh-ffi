...
uint64_t uniffi_iroh_ffi_fn_constructor_endpointbuilder_new(RustCallStatus *_Nonnull out_status
...
RustBuffer uniffi_iroh_ffi_fn_method_iroherror_debug_message(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
...
int8_t uniffi_iroh_ffi_fn_method_iroherror_is_kind(uint64_t ptr, RustBuffer kind, RustCallStatus *_Nonnull out_status
);
#endif
...
RustBuffer uniffi_iroh_ffi_fn_method_iroherror_kind(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
